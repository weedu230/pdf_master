...
export default function WordToPdfPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Word to PDF - PDF Master</title>
        <meta name="description" content="Convert your Word documents to PDF format instantly" />
      </Helmet>

      <div className="max-w-2xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Word to PDF</h1>
        <p className="text-gray-600 mb-8">Convert DOCX files to PDF format instantly</p>
        ...
        {success && (
          <div className="mt-6 p-4 bg-green-50 border border-green-200 text-green-700 rounded-lg">
            <p className="font-semibold">Success! Your PDF is ready to download.</p>
          </div>
        )}
