...
export default function RemovePagesPage() {
  ...
  const handleRemovePages = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.detail || 'Error removing pages');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <>
      <Helmet>
        <title>Remove PDF Pages - PDF Master</title>
        <meta name="description" content="Remove specific pages from your PDF. Delete unwanted pages easily." />
        <meta name="keywords" content="remove pdf pages, delete pdf pages, remove pages from pdf online" />
      </Helmet>

      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-12 md:py-20">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3 md:mb-4 animate-fade-in-up">Remove PDF Pages</h1>
          <p className="text-base md:text-lg text-gray-600 mb-8 md:mb-12 animate-fade-in-up-delay-1">
            Remove selected pages from your PDF. Enter page numbers separated by commas (e.g., 1,3,5).
          </p>
