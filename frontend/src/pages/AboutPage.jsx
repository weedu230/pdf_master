    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 md:px-6 py-10 md:py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 mb-8 mt-12 md:mt-16">
          ...
          {/* Support Section */}
          <div className="bg-gradient-to-br from-red-500 to-red-600 text-white rounded-2xl shadow-2xl p-8 md:p-12 mb-8">
